                    ...
                    <div className="box11 mtop">
                        <div className="row d-flex outln">
                            ...
                            <div className="col-1 proition_seacrh_rel text-center">
                                <Link to='/tvsearch' className='text-decoration-none' style={{ color: '#aaaaaa' }}><FontAwesomeIcon icon="fa-solid fa-magnifying-glass" className='fs-4 p-0 m-0 position_absulte_seacrh' onClick={searchMovies} /></Link>
                            </div>
                        </div>
                    </div>
                </div>}
