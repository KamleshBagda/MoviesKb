    ...
    const searchMovies = async (pageNumber) => {
        try {
            ...
            const response = await fetch(
                `https://api.themoviedb.org/3/search/tv?api_key=${apiKey}&query=${query}&language=en-US&sort_by=popularity.desc&page=${pageNumber}`
            );
