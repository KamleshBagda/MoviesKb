                ...
                <div className="row menupos">
                    ...
                    <div style={{ color: '#aaa', backgroundColor: '#33373d', display: 'none' }} id='categoryshow' >
                        <ul className='list-unstyled me-lg-3 me-xl-4 mb-0'>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='28' >Action</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='80' >Crime</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='35' >Comedy</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='18' >Drama</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='27' >Horror</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='53' >Thriller</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='878' >Science Fiction</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='10749' >Romance</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='16' >Adventure</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='10751' >Family</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='14' >Fantasy</li></Link>
                            <Link to='/categoriesshow' className='text-decoration-none' style={{ color: '#aaaaaa', fontSize: '19px', fontWeight: '400' }}><li className='py-lg-1 px-lg-2 py-xl-2 px-xl-3 rounded ms-4 my-2' onClick={handlecategory} id='9648' >Mystery</li></Link>
                        </ul>
                    </div>
                </div>
            </div>
