...
function CategoriesShow() {
    ...
    //     for (page1; page1 <= totalpage; page1++) {
    //         try {
    //             fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=${genreId}&page=${page1}&include_adult=false`)
                        ...
                        <div className="box11">
                            <div className="row d-flex outln">
                                ...
                                <div className="col-1 proition_seacrh_rel">
                                    <Link to='/search' className='text-decoration-none' style={{ color: '#aaaaaa' }}><FontAwesomeIcon icon="fa-solid fa-magnifying-glass" className='fs-4 p-0 m-0 position_absulte_seacrh' onClick={searchMovies} /></Link>                                </div>
                            </div>
                        </div>
                    </div>}
